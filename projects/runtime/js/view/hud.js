(function (window) {
    ...
    window.opspark.makeHud = function () {
        var hud, background, score, of, txtScore, txtBox, integrity, integrityMeter, winText;
        ...
        background = draw.rect(104, 20, '#000');
        ...
        winText = draw.textfield('You Win!', "100px Arial", 'cyan', 'right');
        
        winText.x = -500;
        winText.y = 300;
        
        txtBox = draw.rect(5,16,'white');
        txtBox.scaleX = 50;
        txtBox.scaleY = 2;
        hud.addChild(txtBox);
